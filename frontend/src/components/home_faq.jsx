...
const FAQSection = () => {
  ...
  return (
    <section className={`py-10 ${fullWidth ? "w-full" : "container mx-auto"}`} style={{ backgroundColor: bgColor }}>
      <div className="text-center mb-10">
        <h3 className="text-3xl font-bold">Curious Minds Ask</h3>
      </div>
      <div className="flex flex-col items-center">
        <div className="w-full max-w-3xl space-y-6">
          {faqs.map((faq, index) => (
            <div key={index} className="p-6 rounded-lg shadow-lg" style={{ backgroundColor: cardBg }}>
